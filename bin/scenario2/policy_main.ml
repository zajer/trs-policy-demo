...
module DemoCombination = Policy.Combination.StatesCombination(Policy_def.Scenario2);;  
module TypedTools = Policy.Tools.Make(Policy_def.Scenario2)
...
let init_state =  (Scenario2.Reachable (init_agent_state,init_set_of_actions)) 
